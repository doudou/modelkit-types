        ...
        module CXX_GCCXML_Common
            def test_cxx_to_typelib_subtype_of_container
                ...
                assert_equal '/std/vector</std/vector</int,/std/allocator</int>>,/std/allocator</std/vector</int,/std/allocator</int>>>>/size_t',
                    CXX::GCCXMLLoader.cxx_to_typelib(cxx_name)
            end
            ...
            def test_split_first_namespace
                assert_equal ["/NS2/", 'NS3/Test'], CXX::GCCXMLLoader.split_first_namespace("/NS2/NS3/Test")
                assert_equal ["/Matrix</double,3,1>/", 'Scalar'], CXX::GCCXMLLoader.split_first_namespace("/Matrix</double,3,1>/Scalar")
                assert_equal ["/Matrix</double,3,1>/", 'Gaussian</double,3>/Scalar'], CXX::GCCXMLLoader.split_first_namespace("/Matrix</double,3,1>/Gaussian</double,3>/Scalar")
                assert_equal ["/std/", "vector</wrappers/Matrix</double,3,1>>"], CXX::GCCXMLLoader.split_first_namespace("/std/vector</wrappers/Matrix</double,3,1>>")
