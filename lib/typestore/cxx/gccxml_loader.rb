...
module TypeStore
    ...
    class GCCXMLInfo
        ...
        def tag_start(name, attributes)
            ...
            if (child_node_name = child_node['name'])
                name_to_nodes[GCCXMLLoader.cxx_to_typestore(child_node_name)] << child_node
            end
            if (child_node_name = child_node['demangled'])
                demangled_to_node[GCCXMLLoader.cxx_to_typestore(child_node_name)] = child_node
            end
    ...
    class GCCXMLLoader
        ...
        # Parses the TypeStore or C++ type name +name+ and returns basename,
        # template_arguments
        ...
        def resolve_type_definition(xmlnode)
            ...
            if kind == "Struct" || kind == "Class"
                ...
                elsif TypeStore::Registry.available_containers.include?(type_name)
        ...
        def load(required_files, xml)
            ...
            TypeStore::Registry.add_standard_cxx_types(registry)
