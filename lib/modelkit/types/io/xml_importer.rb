...
module ModelKit::Types
    module IO
        class XMLImporter
            ...
            def self.import(document, registry: ModelKit::Types::Registry.new)
                new.import(document, registry: registry)
            end

            def import(document, registry: ModelKit::Types::Registry.new)
